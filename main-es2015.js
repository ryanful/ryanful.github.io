...
GalleryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: GalleryComponent, selectors: [["gallery"]], inputs: { id: ["name", "id"] }, decls: 4, vars: 2, consts: [[1, "page"], ["class", "proj-gallery", 4, "ngIf", "ngIfElse"], ["regularGallery", ""], [1, "proj-gallery"], ["class", "image", 3, "background-color", 4, "ngFor", "ngForOf"], [1, "image"], [3, "src"], ["class", "image", 4, "ngFor", "ngForOf"]], template: function GalleryComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
