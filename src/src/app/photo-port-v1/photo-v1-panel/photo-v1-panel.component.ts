...
@Component({
  selector: 'app-photo-v1-panel',
  templateUrl: './photo-v1-panel.component.html',
  styleUrls: ['./photo-v1-panel.component.css']
})
export class PhotoV1PanelComponent implements OnInit {
