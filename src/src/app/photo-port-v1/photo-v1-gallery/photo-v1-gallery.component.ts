...
@Component({
  selector: 'app-photo-v1-gallery',
  templateUrl: './photo-v1-gallery.component.html',
  styleUrls: ['./photo-v1-gallery.component.css']
})
export class PhotoV1GalleryComponent implements OnInit {
